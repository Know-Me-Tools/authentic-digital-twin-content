...
Produce a demonstrative LinkedIn post in Travis's voice under Standard v2 Tier 2 annotation. Domain: agentic programming (workspace identity / context infrastructure).
...
`docs/worked-examples/tier-2-linkedin-post-example.md` exists; compact disclosure tag present; post is in Travis voice (passes rejection filter — no leverage-as-verb, no harness, no delve, no revolutionary); annotation block explains Tier 2 mechanics.
